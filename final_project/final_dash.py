...
fig4 = px.scatter(df, x="residual sugar", y = "pH", color='quality')
...
app.layout = html.Div(children=[
    ...
    html.Div(children='''
         Most of wine PH 3-3.4 sulphates(sulfur dioxide gas (S02) levels，acts as an antimicrobial and antioxidant) 0.4-0.6 alcohol 9-9.5
        '''),
    dcc.Graph(
        id='graph6',
        figure=fig6
